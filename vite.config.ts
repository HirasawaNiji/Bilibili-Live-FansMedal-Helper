  ...
  plugins: [
    ...
    monkey({
      ...
      userscript: {
        ...
        description: {
          '': 'A community-maintained BLTH fork focused on Bilibili live fans medal tasks.',
          en: 'A community-maintained BLTH fork focused on Bilibili live fans medal tasks.',
          zh: '基于 BLTH 修改的哔哩哔哩直播粉丝牌任务助手。',
        },
        ...
        updateURL:
          'https://github.com/HirasawaNiji/Bilibili-Live-FansMedal-Helper/releases/latest/download/bilibili-live-tasks-helper.meta.js',
        downloadURL:
          'https://github.com/HirasawaNiji/Bilibili-Live-FansMedal-Helper/releases/latest/download/bilibili-live-tasks-helper.min.user.js',
